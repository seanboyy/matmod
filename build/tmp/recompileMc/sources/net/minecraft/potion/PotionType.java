...
public class PotionType
{
    ...
    {
        return (PotionType)potionTypeRegistry.getObjectById(p_185169_0_);
    }

    public static int getID(PotionType p_185171_0_)
    {
        return potionTypeRegistry.getIDForObject(p_185171_0_);
    }

    public static PotionType getPotionTypeForName(String p_185168_0_)
    {
        return (PotionType)potionTypeRegistry.getObject(new ResourceLocation(p_185168_0_));
    }
    ...
    {
        return this.name == null ? p_185174_1_ + ((ResourceLocation)potionTypeRegistry.getNameForObject(this)).getResourcePath() : p_185174_1_ + this.name;
    }
    ...
    public static void registerPotionTypes()
    {
        ...
        potionTypeRegistry.validateKey();
    }

    protected static void registerPotionType(String p_185173_0_, PotionType p_185173_1_)
    {
        potionTypeRegistry.register(nextPotionTypeId++, new ResourceLocation(p_185173_0_), p_185173_1_);
    }
