...
public abstract class BiomeGenBase
{
    ...
    public static final RegistryNamespaced<ResourceLocation, BiomeGenBase> biomeRegistry = net.minecraftforge.fml.common.registry.GameData.getBiomeRegistry();
    ...
    public BiomeGenBase(BiomeGenBase.BiomeProperties properties)
    {
     ...
     */
    public static void registerBiome(int id, String name, BiomeGenBase biome)
    {
    ...
    public static class BiomeProperties
        {
            ...
            public BiomeGenBase.BiomeProperties setTemperature(float temperatureIn)
            {
            ...
            public BiomeGenBase.BiomeProperties setRainfall(float rainfallIn)
            {
                this.rainfall = rainfallIn;
                return this;
            }

            public BiomeGenBase.BiomeProperties setBaseHeight(float baseHeightIn)
            {
                this.baseHeight = baseHeightIn;
                return this;
            }

            public BiomeGenBase.BiomeProperties setHeightVariation(float heightVariationIn)
            {
                this.heightVariation = heightVariationIn;
                return this;
            }

            public BiomeGenBase.BiomeProperties setRainDisabled()
            {
                this.enableRain = false;
                return this;
            }

            public BiomeGenBase.BiomeProperties setSnowEnabled()
            {
                this.enableSnow = true;
                return this;
            }

            public BiomeGenBase.BiomeProperties setWaterColor(int waterColorIn)
            {
                this.waterColor = waterColorIn;
                return this;
            }

            public BiomeGenBase.BiomeProperties setBaseBiome(String nameIn)
            {
